...
if (! function_exists("section_button")) {
    function section_button(string $route, string $label = "Sections"): string
    {
        return <<<HTML
        <a href="{$route}"
            title="{$label}"
            class="inline-flex items-center justify-center w-8 h-8 text-indigo-600 hover:text-white hover:bg-indigo-600 border border-indigo-600 rounded-lg transition duration-200"
        >
            <svg xmlns="http://www.w3.org/2000/svg"
                class="w-4 h-4"
                fill="none"
...
if (! function_exists("translation_button")) {
    function translation_button(string $route, string $label = "Translations"): string
    {
        return <<<HTML
        <a href="{$route}"
            title="{$label}"
            class="inline-flex items-center justify-center w-8 h-8 text-purple-600 hover:text-white hover:bg-purple-600 border border-purple-600 rounded-lg transition duration-200"
        >
            <svg xmlns="http://www.w3.org/2000/svg"
                class="w-4 h-4"
                fill="none"
