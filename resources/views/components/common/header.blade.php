        ...
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-20 ltr:-ml-1 rtl:-mr-1 inline" src="{{asset('assets/images/logo.png')}}"
                        alt="image" />
                </a>
            ...
            <div x-data="header"
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span><img class="w-8 h-8 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                src="{{ userImage(Auth::user()->image) }}" alt="user" /></span>
                    </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                            ...
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="rounded-md w-10 h-10 object-cover"
                                        src="{{ userImage(Auth::user()->image) }}"
                                        alt="user" />
                                </div>
                                <div class="ltr:pl-4 rtl:pr-4">
                                    <h4 class="text-base">{{ Auth::user()->name }}</h4>
                                    <span class="text-xs bg-success-light rounded text-success">{{ \App\Enums\UserRole::label(Auth::user()->role_module) }}</span>
