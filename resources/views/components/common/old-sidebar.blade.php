        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard') }}" class="group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Admin Dashboard</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'app' }"
                        @click="activeDropdown === 'app' ? activeDropdown = null : activeDropdown = 'app'">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">App Setup</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'app' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'app'" x-collapse class="sub-menu text-gray-500">

                        <li>
                            <a href="{{ route('appSlider.list') }}">Slider</a>
                        </li>
                    </ul>
                </li>
                ...
                {{-- Audit Logs  --}}
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'audit' }"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Audit Logs') }}</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'audit'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{ route('audit.logs') }}">{{ __('Logs') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('audit.settings') }}">{{ __('Settings') }}</a>
                        </li>
                    </ul>
                </li>
                {{-- File Manager --}}
                <li class="nav-item">
                    <a href="{{ route('fileManager.list') }}" class="group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{__('File Manager')}}</span>
                        </div>
                    </a>
                </li>
                {{-- Custom fields --}}
                <li class="nav-item">
                    <a href="{{ route('customField.index') }}" class="group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{__('Custom Fields')}}</span>
                        </div>
                    </a>
                </li>
                {{-- Role  --}}
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'role' }"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Role Management') }}</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'role'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{ route('role.index') }}">{{ __('Web Role') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('role.apiRole') }}">{{ __('Api Role') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('role.webPermission') }}">{{ __('Web Permissions') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('role.apiPermission') }}">{{ __('Api Permissions') }}</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'settings' }"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Settings') }}</span>
                        </div>
                ...
                {{-- faq  --}}
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'faq' }"
                            @click="activeDropdown === 'faq' ? activeDropdown = null : activeDropdown = 'faq'">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('FAQ') }}</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'faq' }">
                ...
                {{-- Error Logs  --}}
                <li class="menu nav-item">
                    <a href="{{ route('errorLog') }}" target="_blank" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Error Logs</span>
                        </div>
                    </a>
                </li>
