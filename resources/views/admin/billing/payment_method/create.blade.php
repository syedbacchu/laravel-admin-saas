<x-layout.default>
    ...
    @php
        ...
        $details = (array) old('details', $currentItem?->details_json ?? []);
    @endphp
    ...
    <div class="panel mt-6" x-data="{ tab: '{{ $defaultLanguageId }}' }">
        ...
        <form method="POST" action="{{ $currentItem ? route('paymentMethod.update', $currentItem->id) : route('paymentMethod.store') }}">
            @csrf
            @if($currentItem)
                @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div class="mb-2">
                    ...
                    <div class="flex">
                        {!! defaultInputIcon() !!}
                        <input name="code" type="text" value="{{ old('code', $currentItem?->code ?? '') }}" class="form-input ltr:rounded-l-none rtl:rounded-r-none" placeholder="bkash" required />
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div class="mb-2">
                    ...
                    <div class="flex">
                        {!! defaultInputIcon() !!}
                        <input name="details[mobile_number]" type="text" value="{{ $details['mobile_number'] ?? '' }}" class="form-input ltr:rounded-l-none rtl:rounded-r-none" />
                    </div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="flex">
                        {!! defaultInputIcon() !!}
                        <input name="details[account_number]" type="text" value="{{ $details['account_number'] ?? '' }}" class="form-input ltr:rounded-l-none rtl:rounded-r-none" />
                    </div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="flex">
                        {!! defaultInputIcon() !!}
                        <input name="details[bank_name]" type="text" value="{{ $details['bank_name'] ?? '' }}" class="form-input ltr:rounded-l-none rtl:rounded-r-none" />
                    </div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="flex">
                        {!! defaultInputIcon() !!}
                        <input name="details[branch_name]" type="text" value="{{ $details['branch_name'] ?? '' }}" class="form-input ltr:rounded-l-none rtl:rounded-r-none" />
                    </div>
                </div>
            </div>
