...
<script src="{{ asset('assets/common/datatables/jquery.dataTables.min.js') }}"></script>
    ...
    <div class="mt-8 bg-white shadow-xl rounded-2xl p-6 border border-gray-100">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
            <h5 class="text-2xl font-bold text-gray-800">{{ $pageTitle ?? __('Language List') }}</h5>
        ...
        <div class="overflow-x-auto">
            <x-common.datatable
                id="itemsTable"
                ajax="{{ route('language.list') }}"
                :columns="[
                    ['data' => 'display_name', 'name' => 'name', 'title' => 'Language'],
                    ['data' => 'code', 'name' => 'code', 'title' => 'Code'],
                    ['data' => 'direction', 'name' => 'direction', 'title' => 'Direction'],
